...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_shouldDrawPlaceholder) {
        ...
        if (self.stype==1)
        {
            if (self.stype_1==2)
            {
                [_placeholder drawInRect:CGRectMake(5.0f, 6.0f, self.frame.size.width - 16.0f, self.frame.size.height - 16.0f) withFont:self.placeholderFont];
            }else{
            [_placeholder drawInRect:CGRectMake(54.0f, 6.0f, self.frame.size.width - 16.0f, self.frame.size.height - 16.0f) withFont:self.placeholderFont];
            }
        }else{
